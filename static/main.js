...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aw: fragment, az: host, aG: path, aI: port_, aN: protocol, aO: query};
	});
...
var $author$project$Main$AskForJwt = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$GotUsers = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$LoadingUsers = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Common$userDecoder = A9(
	...
	A2($elm$json$Json$Decode$field, 'cost_last_30_days', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'cost_this_month', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'cost_last_month', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'alc_ml_last_30_days', $elm$json$Json$Decode$float));
var $author$project$Common$getUsers = F2(
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {aL: processes, a_: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.a_);
		if (_v0.$ === 1) {
			return $elm$core$Task$succeed(state);
		} else {
			var taggers = _v0.a;
...
var $author$project$Main$LoadingProducts = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Common$OrderUser = 1;
...
var $author$project$Main$areNewOrdersEmpty = function (orders) {
...
var $author$project$Common$productDecoder = A3(
						...
						A3(
							...
							A3(
								...
								A3(
									...
									$elm$json$Json$Decode$succeed($author$project$Common$Product))))))))));
var $author$project$Common$getProducts = F2(
	function (jwtToken, msg) {
		return $elm$http$Http$request(
			{
				t: $elm$http$Http$emptyBody,
...
var $author$project$Common$username = function (user) {
	if (!user) {
		return 'xxxx_user';
	} else {
		return 'order_user';
...
var $author$project$Common$get_jwt_token = F3(
...
var $author$project$Common$NewOrder = F3(
	function (user, product, amount) {
		return {ag: amount, aM: product, a0: user};
	});
var $author$project$Common$product2order = F2(
	function (user, product) {
		return A3($author$project$Common$NewOrder, user, product, 0);
	});
...
var $author$project$Main$setPersistance = _Platform_outgoingPort(
	'setPersistance',
	function ($) {
...
var $author$project$Main$stripLeft = function (string) {
	return A2($elm$core$String$startsWith, ' ', string) ? $author$project$Main$stripLeft(
...
var $author$project$Main$stripRight = function (string) {
	return A2($elm$core$String$endsWith, ' ', string) ? $author$project$Main$stripRight(
		A2($elm$core$String$dropRight, 1, string)) : string;
};
var $author$project$Main$strip = function (string) {
	return $author$project$Main$stripRight(
		$author$project$Main$stripLeft(string));
};
var $elm$core$String$toLower = _String_toLower;
var $author$project$Main$showProduct = F2(
	function (location, product) {
		return A2(
			$elm$core$List$member,
			$author$project$Main$strip(
				$elm$core$String$toLower(location)),
			A2(
				$elm$core$List$map,
		...
		switch (msg.$) {
				...
				if (!result.$) {
					...
					switch (model.$) {
						case 2:
							var persistance = model.a;
							return _Utils_Tuple2(
								A2($author$project$Main$LoadingProducts, persistance, users),
								A2($author$project$Common$getProducts, persistance.l, $author$project$Main$GotProducts));
						case 4:
							var state = model.a;
							return _Utils_Tuple2(
					...
					switch (model.$) {
						case 2:
							var persistance = model.a;
							return _Utils_Tuple2(
								$author$project$Main$Failure(persistance),
								$elm$core$Platform$Cmd$none);
						case 4:
							var state = model.a;
							return _Utils_Tuple2(
			...
			case 2:
				...
				if (model.$ === 4) {
					...
					return _Utils_Tuple2(
						$author$project$Main$Failure(state.e),
						$elm$core$Platform$Cmd$none);
				}
			case 3:
				var state = msg.a;
				...
				var newNewOrders = A2(
					$elm$core$List$map,
					function (o) {
						return _Utils_eq(o.aM.q, order.aM.q) ? _Utils_update(
							o,
							{ag: o.ag + 1}) : o;
					},
					buyState.f);
				...
				return _Utils_Tuple2(
					A2(
						...
						_Utils_update(
							buyState,
							{
								f: A2($elm$core$List$map, $author$project$Common$resetAmount, buyState.f)
							})),
					$elm$core$Platform$Cmd$none);
			case 6:
				var state = msg.a;
				var buyState = msg.b;
				var user = buyState.a0;
				...
				var new_persistance = _Utils_update(
					persistance,
					{
						f: _Utils_ap(persistance.f, new_orders)
					});
				...
				var user_updated = _Utils_update(
					user,
					{a6: user.a6 + alcohol, bb: user.bb + cost, bd: user.bd + cost});
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'user_id',
									$elm$json$Json$Encode$int(order.a0.q)),
									_Utils_Tuple2(
									'product_id',
									$elm$json$Json$Encode$int(order.aM.q)),
									_Utils_Tuple2(
									'amount',
			...
			case 11:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$setPersistance(persistance),
								A2($author$project$Common$getUsers, persistance.l, $author$project$Main$GotUsers)
							])));
			default:
				var result = msg.a;
...
var $author$project$Main$ResetAmounts = F2(
	function (a, b) {
		return {$: 5, a: a, b: b};
	});
...
var $author$project$Design$button = F3(
	function (_v0, label, msg) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'marin', '10px'),
...
var $author$project$Main$ClickedProduct = F3(
	function (a, b, c) {
...
var $author$project$Main$userView = F2(
	function (state, user) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick(
					A2($author$project$Main$ClickedUser, state, user)),
					A2($elm$html$Html$Attributes$style, 'margin', '10px'),
					A2($elm$html$Html$Attributes$style, 'text-align', 'center'),
					A2($elm$html$Html$Attributes$style, 'touch-action', 'manipulation')
				]),
...
var $author$project$Design$yellow = A2($author$project$Design$ButtonColor, '#FDB60D', '#212529');
var $author$project$Main$view = function (model) {
	switch (model.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Please Enter Setup password: ')
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput($author$project$Main$AskForJwtTextUpdate)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$h2,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Please enter location (e.g. \"Bar\", \"Kühlschrank\", …)')
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput($author$project$Main$AskForJwtLocationUpdate)
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$GetJwt)
							]),
						_List_fromArray(
							[
		...
		case 4:
			var state = model.a;
			var title = state.F ? 'Strichliste *' : 'Strichliste';
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'margin', '10px 10px 10px 10px ')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$GetUsers(persistance))
							]),
						_List_fromArray(
							[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Loading Products')
							]))
					]));
		default:
			var state = model.a;
			var buyState = model.b;
			var resetButton = $author$project$Main$areNewOrdersEmpty(buyState.f) ? A2($elm$html$Html$div, _List_Nil, _List_Nil) : A3(
				$author$project$Design$button,
				$author$project$Design$yellow,
				'Zurücksetzen',
				A2($author$project$Main$ResetAmounts, state, buyState));
			var confirmButton = $author$project$Main$areNewOrdersEmpty(buyState.f) ? A3(
				$author$project$Design$button,
				$author$project$Design$red,
				'Zurück',
				A2($author$project$Main$CommitNewOrder, state, buyState)) : A3(
				$author$project$Design$button,
				$author$project$Design$green,
				'Eintragen',
				A2($author$project$Main$CommitNewOrder, state, buyState));
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($myrho$elm_round$Round$round, 2, buyState.a0.bb) + '€')
							])),
						A2(
						$elm$html$Html$h2,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($myrho$elm_round$Round$round, 2, buyState.a0.bd) + '€')
							])),
						A2(
						$elm$html$Html$h2,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($myrho$elm_round$Round$round, 2, buyState.a0.bc) + '€')
							])),
						A2(
						$elm$html$Html$h2,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($myrho$elm_round$Round$round, 2, (buyState.a0.a6 / 0.05) / 1000))
							]))
					]));
	}
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{bk: $author$project$Main$init, bu: $author$project$Main$subscriptions, bx: $author$project$Main$update, by: $author$project$Main$view});
						...
						return A2(
							...
							A2(
								...
								A2(
																				...
																				return A2(
																					...
																					function (description) {
																						return A2(
																							...
																							A2($elm$json$Json$Decode$field, 'alcohol_content', $elm$json$Json$Decode$float));
																					},
									...
									A2($elm$json$Json$Decode$field, 'volume_in_ml', $elm$json$Json$Decode$float))));
					},
					A2(
						$elm$json$Json$Decode$field,
						'user',
							...
							function (name) {
								return A2(
									...
									function (id) {
										return A2(
											$elm$json$Json$Decode$andThen,
											function (cost_this_month) {
												return A2(
													$elm$json$Json$Decode$andThen,
													function (cost_last_month) {
														return A2(
															$elm$json$Json$Decode$andThen,
															function (cost_last_30_days) {
																return A2(
																	$elm$json$Json$Decode$andThen,
																	function (avatar) {
																		return A2(
																			$elm$json$Json$Decode$andThen,
																			function (alc_ml_last_30_days) {
																				return A2(
																					$elm$json$Json$Decode$andThen,
																					function (active) {
																						return $elm$json$Json$Decode$succeed(
